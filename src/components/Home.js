...
function Home() {
  ...
  return (
    <div className="home">
      <header className="hero">
        <h1>Water Management System</h1>
        <p>Efficient solutions for water conservation and smart usage.</p>
      </header>
        ...
        {data.length > 0 ? (
          <>
            ...
            <div className="data-card">
              <p>
                <strong>Distance:</strong> {data[0].distance}
              </p>
              <p>
              <strong>Motor:</strong> {data[0].motor === 1 ? "ON" : "OFF"}
              </p>
              <p>
              <strong>Valve:</strong> {data[0].valve === 1 ? "OPEN" : "CLOSE"}
              </p>
              <p>
                <strong>Volume 1:</strong> {data[0]["volume 1"]} L
              </p>
              <p>
                <strong>Volume 2:</strong> {data[0]["volume 2"]} L
              </p>
              <p>
                <strong>Average:</strong> {data[0].avg} L
              </p>
              <p>
                <strong>TDS:</strong> {data[0].tds} ppm
              </p>
            </div>
      ...
      <section className="content">
        <h2>Why Water Management Matters?</h2>
        <p>
          Water conservation is essential for sustainable living. Our platform helps you track, analyze, and optimize water usage.
        </p>
        <div className="media-space">
          [Add Images/Videos Here]
        </div>
